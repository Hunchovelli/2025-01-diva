...
import "xdeployer";
// Commented out because I had to remove @matterlabs/hardhat-zksync-verify because it was using openzeppelin version 4.9.6
// which was conflicting with the one specified in package.json (5.0.2) and causing issues at initialization of the owner in AaveDIVAWrapper.sol.
...
import { getForkConfig } from "./utils/forkConfig";

// Turning off the automatic Tenderly verification
tdly.setup({ automaticVerifications: false });

// Network to use for testing. Currently supported networks: "polygon", "arbitrumMain"
